...
# def possible_values_for_cell_2(i, j):
#     return R[i][0].difference(R[i][1:]) & \
#            C[j][0].difference(C[j][1:]) & \
#            S[SQUARE_MAP[(i, j)]][0].difference(S[SQUARE_MAP[(i, j)]][1:])
...
# def update_rcs_2(i, j, val, ):
#     global R, C, S

#     R[i].append(val)
#     C[j].append(val)
#     S[SQUARE_MAP[(i, j)]].append(val)
